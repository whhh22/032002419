...
def getData_dicValues(match: tuple, data_dic: dict, list):
...
g_a_t_calConfirm = [0, 0, 0]  # 记录港澳台上一次累计新增病例
...
for match in match_list:
    ...
    data_dic, ls = getData_dicValues(match, data_dic, g_a_t_calConfirm_new)
    for i in range(3):
